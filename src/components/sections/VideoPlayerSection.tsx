...
function VideoPlayerSection() {
  ...
  return (
    <section className="flex flex-col md:flex-col justify-center items-center mt-[11.31rem]" id="about">
      {loadingTranslation ? (
      ...
      <div className="flex flex-row mt-20 mb-10 items-center justify-center">
      ...
      {loadingTranslation ? (
          ...
          <img src="/images/PhotoHeader.png" alt="video player" className="w-fit mb-14"/>
        )
      }
      </div>
