...
function NewsletterSection() {
  ...
  useEffect(() => {
    ...
    if (language === "en") {
      ...
      setImageSrc(`/images/test2PM1.png`);
    } else {
    ...
    <section className="pt-[15rem] md:pt-[6rem] overflow-hidden 2xl:pt-4 lg:pt-28 stm:pt-12 " id="download">
      ...
      {loadingTranslation ? (
          ...
          <div className="flex flex-col md:flex-col items-center md:mt-[2.31rem] sm:mt-0 2xl:flex-row lg:flex-row">
            ...
            <div>
              <p className="mb-[1.44rem] ml-8  mr-8 text-normal font-semibold text-customGray sm:mb-0 sm:ml-2 stm:mb-0 stm:ml-0">
                {t("DownloadDesc1")}
              </p>
              <iframe className="flex h-screen w-full mb-[-8rem]" src="https://2d19fcc2.sibforms.com/serve/MUIFACOMFxBjSF6GTdFS1gDWUAjK0WK6yBs1Z0dyTmMJpWnNAYxzzzqfxbuegMSSMYNbnaWaUTJ71QUkT6PKpYvcbo7NPjuEADq-kJUO2PPxnD6fBtFwQ5N3I1OZaroSonWVA_4jOe31ichoc987_T3mMQyLjaK26XT4j0GeuScgBfqTKAFGQfgTWUhOaHQpkC0rNvunjOJXR4fH"></iframe>
