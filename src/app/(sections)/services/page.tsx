...
function ServiceSection() {
  ...
  return (
    <section id="services" className="pt-[10rem] lg:pt-[0.5rem] lg:mb-[10rem] 2xl:pt-4">
       {loadingTranslation ? (
        ...
        {loadingTranslation ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3  gap-[3.56rem] justify-around mt-8 md:mt-[6.75rem] ">
